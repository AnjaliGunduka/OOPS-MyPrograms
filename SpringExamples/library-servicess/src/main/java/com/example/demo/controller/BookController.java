...
public class BookController {
	...
	public ResponseEntity<BookRequest> createCollege(@Valid @RequestBody BookRequest bookRequest) {
		Book createdBook = bookService.createBook(bookRequest);
		ModelMapper modelMapper = new ModelMapper();
		return ResponseEntity.status(HttpStatus.OK).body(modelMapper.map(createdBook, BookRequest.class));
	}

	@ApiOperation(value = "Gets a Book")
	@ApiResponses(value = {
	...
	@ApiOperation(value = "Get All the Books")
	@ApiResponses(value = {
