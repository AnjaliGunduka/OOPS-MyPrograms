...
public class ProvideBookServiceTest {
	...
	public ProvideBookRequest getProvideBookRequest() {
		ProvideBookRequest provideBookRequest = new ProvideBookRequest(1L, 1L, 1, RequestStatus.APPROVED);
		return provideBookRequest;
	}

	public RequestBook testRequestBooks() {
		RequestBook requestBook = new RequestBook(3L, "core", RequestStatus.REQUESTED, "12345", 1, LocalDate.now(),
