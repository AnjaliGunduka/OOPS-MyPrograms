...
public class BooksServiceApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		...
		System.out.println("NO.of Books are:-" + list.stream().count()); 
	
		list.stream().filter(Book ->  Book.getId() == "3") 

		.forEach(Book  -> System.out.println("name of student:-" + Book.getId())); 
		
		
		Optional<Book> op = list.stream().findFirst(); 
