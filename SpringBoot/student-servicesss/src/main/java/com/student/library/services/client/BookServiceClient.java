...
@FeignClient(url = "http://localhost:8683", name = "BOOK-SERVICE-CLIENT")
public interface BookServiceClient {
	...
	@GetMapping(value = "/bookService/book/{bookName}")
	...
	RequestBook addProvideBook(@RequestHeader(name = "Authorization") String authorization,
			@RequestBody ProvideBookRequest provideBookRequest);

	@GetMapping(value = "/bookService/student/{id}")
