...
public class RequestBook {
	...
	public RequestBook(Long id, String bookName, RequestStatus status, String cardNo, int noOfBooks,
			Instant requestDate, Student student, Book book) {
		super();
		this.id = id;
		this.bookName = bookName;
		this.status = status;
	...
	public String toString() {
		return "RequestBook [id=" + id + ", bookName=" + bookName + ", status=" + status + ", cardNo=" + cardNo
				+ ", noOfBooks=" + noOfBooks + ", requestDate=" + requestDate + ", student=" + student + ", book="
				+ book + "]";
	}
