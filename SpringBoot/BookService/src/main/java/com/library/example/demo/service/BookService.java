...
import com.library.example.demo.Entity.Book$;
import com.library.example.demo.Exception.NotFoundException;
import com.library.example.demo.Repository.BookRepository;
...
//		return jpaStreamer.stream(Book.class).filter(book -> book.getBookName().equals(bookName)).findFirst()
